 ...
 * @UniqueEntity(
 * fields={"email"},
 * message="Adresse mail déjà utilisée, merci de la modifier !"
 * )
 */
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     *  @Assert\NotBlank(message="Veuillez renseigner un mail valide !")
     */
    private $lastName;
    ...
    /**
     * @Assert\EqualTo(propertyPath="hash", message="Votre mot de passe ne correspond pas !")
     *
     */
